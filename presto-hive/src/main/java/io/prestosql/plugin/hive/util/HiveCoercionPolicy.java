...
public final class HiveCoercionPolicy
{
     ...
     */
    public static Optional<HiveType> coercibleIntermediate(TypeManager typeManager, HiveType fromHiveType, HiveType toHiveType)
    {
        return new HiveCoercionPolicy(typeManager).coercibleIntermediate(fromHiveType, toHiveType);
    }

    private Optional<HiveType> coercibleIntermediate(HiveType fromHiveType, HiveType toHiveType)
    {
